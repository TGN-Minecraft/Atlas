...
import net.avicus.atlas.localization.text.LocalizableFormat;
import net.avicus.atlas.localization.text.UnlocalizedFormat;
...
public class LocalizedConfigurationProperty {
  ...
  public String render(CommandSender viewer) {
    BaseComponent component = this.text.translate(viewer);
